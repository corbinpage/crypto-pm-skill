...
See [routines/](routines/) for scheduled background automations that complement these workflows (e.g. daily customer-feedback triage via GitHub Actions + Claude MCP).
