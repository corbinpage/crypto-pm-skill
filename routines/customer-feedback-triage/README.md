...
**Last run:** `1970-01-01T00:00:00Z` &nbsp;·&nbsp; **Status:** ❌ failure &nbsp;·&nbsp; **Duration:** 1.2s
...
```
400 {"type":"error","error":{"type":"invalid_request_error","message":"tools.0.mcp_toolset.mcp_server_name: Field required"},"request_id":"req_011Cd9icRQQPnKtkN9nhAzkf"}

Error: 400 {"type":"error","error":{"type":"invalid_request_error","message":"tools.0.mcp_toolset.mcp_server_name: Field required"},"request_id":"req_011Cd9icRQQPnKtkN9nhAzkf"}
