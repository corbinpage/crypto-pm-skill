...
```
400 {"type":"error","error":{"type":"invalid_request_error","message":"MCP server 'notion' is defined but not referenced by any `mcp_toolset` in `tools`."},"request_id":"req_011Cahp3NLbasQG7SNzXcqM8"}

Error: 400 {"type":"error","error":{"type":"invalid_request_error","message":"MCP server 'notion' is defined but not referenced by any `mcp_toolset` in `tools`."},"request_id":"req_011Cahp3NLbasQG7SNzXcqM8"}
